...
function Section1() {
  ...
  return (
    ...
    <div className=' section1-text-container w-full p-5 md:p-0 md:w-[50%] flex flex-col justify-center h-full gap-2 md:pt-5'>
        ...
        <h1 className=' text-[4vw] font-bold italic text-gray-700 dark:text-white/70'>
            Explore And Learn In Community
        </h1>
        <p className='text-gray-500 md:text-sm text-xs text-justify  dark:text-white/60'>
       ...
       <div className='w-full flex items-center justify-center'>
        ...
        <button className='section1-text-container-button flex items-center text-base font-bold px-2 bg-[#ff9f1c] border rounded-lg  text-white dark:border-0'>Get Started <i className="ri-arrow-right-line pt-1 text-orange-700 w-[2vw] text-lg  "></i></button>
       </div>
      <p className='w-full text-sm font-semibold text-gray-600 section1-last-para dark:text-white/60'>Let's Start a new Journey Of Knowledge and Interest</p>
    
    </div>
    <motion.div className='md:w-[45%] w-full flex items-center justify-center  h-[100%] p-5 border border-2 border-gray-200 rounded-xl relative  shadow-lg dark:border-white/70 '
